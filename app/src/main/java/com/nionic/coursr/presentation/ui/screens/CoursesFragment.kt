...
import com.nionic.coursr.databinding.FragmentCoursesBinding
...
class CoursesFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        initRecycler()
        setupObservers()
        binding?.laySort?.setOnClickListener { courseViewModel.sortByPublishDate() }
    ...
    private fun setupObservers() {
        lifecycleScope.launch {
            courseViewModel.sortedCourses.collect { courses ->
